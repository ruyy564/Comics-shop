			...
			<section class="section">
				<div class="section-menu">
					<ul class="section-menu-list">
						<li class="section-menu-item">Новинки</li>
					</ul>
				</div>
				<div class="goods">
				<?php 
					$comics=get_new_comicses();
					foreach ($comics as $comicsItem): ?>
					<div class="good">
						<a href="good.php?id=<?=$comicsItem['id']?>">
							<div class="good-img">
								<img src="<?php  echo "template/img/".$comicsItem["cover"]?>" alt="" class="img-good">
							</div>
						</a>
						<h1  class="good-title"><?php  echo $comicsItem["name"]?></h1>
						<span  class="good-price"><?php  echo $comicsItem["price"]?> руб</span>
						<div class="good-buy">
							<a href="#" data-id="<?=$comicsItem['id']?>" class="good-button-buy">
